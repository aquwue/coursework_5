...
class Arena(metaclass=BaseSingleton):
    ...
    def next_turn(self):
        ...
        # TODO если result -> возвразаем его
        # TODO если нет и игра идет (if game_is_running)
    ...
    def _end_game(self):
        # TODO ЗАВЕРШЕНИЕ ИГРЫ - > return result: str
    ...
    def player_hit(self):
        # TODO УДАР ИГРОКА -> return result: str
        # TODO получаем результат от функции self.player.hit
        # TODO включаем следующий ход
        # TODO возвращаем результат удара
        pass

    def player_use_skill(self):
        # TODO ИГРОК ИСПОЛЬЗУЕТ УМЕНИЕ
